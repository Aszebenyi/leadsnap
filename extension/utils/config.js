...
export const FACEBOOK_APP_ID   = '1174132861450501';
// Redirect URI is determined at runtime via chrome.identity.getRedirectURL() — displayed
// on the onboarding page so you can copy it into Facebook App → Facebook Login → Settings.
